...
rootpath = "C:\\Users\ashis\Desktop\music"
pattern = "*.mp3"
...
listBox = tk.Listbox(canvas, fg = "cyan", bg = "black" , width = 100, font =('Montserrat SemiBold', 14))
listBox.pack(padx = 15, pady = 15)

label = tk.Label(canvas, text = '', bg = 'black', fg = 'yellow', font = ('Montserrat SemiBold', 14) )
label.pack(pady = 15 )
